    ...
    <div class="row">
        <!-- <div class="col-md-8 col-md-offset-2" > -->
            ...
            <div class="panel panel-default">
                ...
                <div class="container">
                    <div class="panel-heading" style="margin-left: 128px;">
                        <center><p style="padding: 0 25px; font-size: 22px; font-weight: 600; letter-spacing: .1rem; text-decoration: none; text-transform: uppercase;"><strong>SEARCH</strong></p></center>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <div class="row" > -->
                                        <div class="container" style="margin-left: 70px;">
                                            <hr>
                                            <center><p style="color: #636b6f; padding: 0 25px; font-size: 12px; font-weight: 600; letter-spacing: .1rem; text-decoration: none; text-transform: uppercase;">Select subject field/s:</p></center>
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col" align="center" style="">
                                                <center>
                                                    <button type="submit" class="btn" style="background-color:RGB(164, 16, 19); color: white; margin-left: 420px;">Start Search</button>
                                                </center>
