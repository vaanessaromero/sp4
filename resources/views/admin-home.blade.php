...
<div class="container">
    <div class="container" align="center" style="margin-top: 100px;">
        <div class="floated_img" style="float: left; margin-right: 50px; margin-top: 50px">
            <a href="/userCRUD" class="btn btn-default btn-rounded mb-4"><img style="width: 150px;" src="{{ asset('https://res.cloudinary.com/dzhe5doam/image/upload/v1557200949/manage_users_logo.png') }}"></a>
            <center><p style="font-size: 15px; color: black"><strong>MANAGE USERS</strong></p></center>
        </div>
        <div class="floated_img" style="float: left; margin-right: 50px; margin-top: 50px">
