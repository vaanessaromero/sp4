...
<div class="container" style="width:800px; margin:0 auto;">
    <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" align="center" style="width: 30%;padding-bottom: 5px;border-radius: 10px;background-color: #77ab59;width:800px; margin:0 auto;">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                            <label for="first_name" class="col-md-4 control-label" style="color: #234d20">First Name</label>
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label" style="color: #234d20">Last Name</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label" style="color: #234d20">Confirm Password</label>
                        ...
                        <div class="form-group{{ $errors->has('branch') ? ' has-error' : '' }}">
                            <label for="branch" class="col-md-4 control-label" style="color: #234d20">Regional Office</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <br><button type="submit" class="btn" style="font-size: 12px; font-weight: 600; letter-spacing: .1rem; text-decoration: none; text-transform: uppercase;background-color:white; color: #234d20;">
                                    Register
                                </button>
                            </div>
                        </div>
